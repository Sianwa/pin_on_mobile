        ...
        binding.fab.setOnClickListener(view -> {
            ...
            try {
                Institution institution = new Institution("IKIA971FB5996EADBD16534494CB87B90D1DB3EAD105"
                        ,"ONcmxGU4B+A+qaHp+/Nw19yO9w117PY36/SxsH1A1Wc=",6,
                        rsaPubKeyString,rsaPrivateKeyString,"deee79ba-f912-11eb-9a03-0242ac130003");
                Account account = new Account("552004400032","1410519");
                PinOnMobile pinOnMobile = PinOnMobile.getInstance(MainActivity.this,institution,account);
                pinOnMobile.changePin(response -> Snackbar.make(view, "Setpin correctly occurred", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show(), error -> Snackbar.make(view, "Error occurred", Snackbar.LENGTH_LONG)
